 ...
 * @author cixtic04
 */
public class ComboModelTipo  extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    private ArrayList<BeanImpresion> data = new ArrayList();

    public ComboModelTipo() {
        BeanImpresion mes1=new BeanImpresion("S","SUNAT");
        data.add(mes1);
        BeanImpresion mes2=new BeanImpresion("C","Comprobación ");
        data.add(mes2);
