 ...
 * @author 777
 */
public class ComboModelCuentaEfectivo extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    private ArrayList<BeanBanco> data = new ArrayList();

    public ComboModelCuentaEfectivo() {
    }

    public ComboModelCuentaEfectivo(ArrayList<BeanBanco> datos) {
        data = datos;
    }
