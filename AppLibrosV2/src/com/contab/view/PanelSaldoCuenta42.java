...
import com.contab.logic.LogicSaldoCuenta42;
...
public class PanelSaldoCuenta42 extends JPanel {
    ...
    private FrmPanel panelSaldoCuenta42= new FrmPanel(ViewLogin.picture.getIconCuenta14(), "SALDO CUENTA 42");
    ...
    public PanelSaldoCuenta42() throws SQLException {
        initComponets();
    }
    ...
    private void exportarSaldoCuenta42AEXCEL() throws SQLException {
        ...
        try {
            File archivo = seleccionarArchivo(filterXLS, "SaldoCuenta42", "xlsx");
      ...
      //  } else
            ...
            if (chkemp.isSelected()) {
              ...
              LogicSaldoCuenta42.listaSaldoCuenta42(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo,tipo, archivo, "xlsx");
            //return "EMP";
            } else if (chkacc.isSelected()) {
           // return "ACC";
                  LogicSaldoCuenta42.listaSaldoCuenta42X(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo,tipo, archivo, "xlsx");
            }
    ...
    private void exportarSaldoCuenta42APDF() throws SQLException {
      ...
      // String tipo=objImpresion.getNumero();
           String tipo=objImpresion.getNumero();
        try {
            File archivo = seleccionarArchivo(filterPDF, "SaldoCuenta42", "pdf");
           
        
           if (chkemp.isSelected()) {

              LogicSaldoCuenta42.listaSaldoCuenta42(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo,tipo, archivo, "pdf");
            //return "EMP";
            } else if (chkacc.isSelected()) {
           // return "ACC";
                  LogicSaldoCuenta42.listaSaldoCuenta42X(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo,tipo, archivo, "pdf");
            }
     ...
     private void exportarSaldoCuenta42ADOC() throws SQLException {
        ...
        //  String descfMes = panelRptLibroCaja.getFinFecha().getSelectedItem().toString();
        try {
            File archivo = seleccionarArchivo(filterTXT, "SaldoCuenta42", "docx");
              ...
              if (chkemp.isSelected()) {
               ...
               LogicSaldoCuenta42.listaSaldoCuenta42(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo,objImpresion.getNumero(), archivo, "docx");
            //return "EMP";
            } else if (chkacc.isSelected()) {
           // return "ACC";
                   LogicSaldoCuenta42.listaSaldoCuenta42X(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo,objImpresion.getNumero(), archivo, "docx");
            }
