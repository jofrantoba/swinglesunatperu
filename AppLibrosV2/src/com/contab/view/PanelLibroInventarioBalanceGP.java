...
import com.contab.logic.LogicLibroInventarioBalanceGP;
...
public class PanelLibroInventarioBalanceGP extends JPanel {
    ...
    private FrmPanel panelCuenta41= new FrmPanel(ViewLogin.picture.getIconCuenta14(), "LIBRO DE INVENTARIOS Y BALANCES  ESTADO DE GANANCIAS Y PÉRDIDAS ");
    ...
    public PanelLibroInventarioBalanceGP() throws SQLException {
        initComponets();
    }
    ...
    private void exportarCuenta41AEXCEL() throws SQLException {
        ...
        try {
            ...
            LogicLibroInventarioBalanceGP.listaLibroInventarioBalanceGP(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo, archivo, "xlsx");
    ...
    private void exportarCuenta41APDF() throws SQLException {
        ...
        try {
            File archivo = seleccionarArchivo(filterPDF, "Cuenta41", "pdf");
              ...
              LogicLibroInventarioBalanceGP.listaLibroInventarioBalanceGP(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo, archivo, "pdf");
     ...
     private void exportarCuenta41ADOC() throws SQLException {
        ...
        try {
            ...
            LogicLibroInventarioBalanceGP.listaLibroInventarioBalanceGP(objEmpresa.getDescripcion(), objEmpresa.getRuc(), objEmpresa.getCodigo(), periodo, archivo, "doc");
    ...
    public FrmPanel getLibroInventarioBalanceGP() {
