 ...
 */
public class DataSourceRptSunat implements JRDataSource {
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
        ...
        if("CONTADOR".equals(jrf.getName())){
            ...
            valor=lista.get(cursor).getDireccion();
        }else if("DEPARTAMENTO".equals(jrf.getName())){
            valor=lista.get(cursor).getDepartamento();
        }else if("PROVINCIA".equals(jrf.getName())){
            valor=lista.get(cursor).getProvincia();
        }else if("DISTRITO".equals(jrf.getName())){
            valor=lista.get(cursor).getDistrito();
        }else if("OPERACIONES".equals(jrf.getName())){
            valor=lista.get(cursor).getOperaciones();
        }        
