 ...
 */
public class ModelTabla10 extends AbstractTableModel {

    private ArrayList<String> headerTable = new ArrayList();
    private ArrayList<BeanTabla10> data = new ArrayList();
    private ArrayList<TableModelListener> listeners = new ArrayList();
    private JTable tablaDatos;
    private HashSet<BeanTabla10> listaCommit = new HashSet();

    public ModelTabla10(JTable tabla) {
        tablaDatos = tabla;
        createHeaders();
    }

    public ModelTabla10(ArrayList<BeanTabla10> lista) {
        data = lista;
        createHeaders();
    }
    ...
    public void insertar(BeanTabla10 i) {
        data.add(i);
        TableModelEvent evento;
    ...
    public void update(BeanTabla10 i, int fila) {
        data.remove(fila);
        data.add(fila, i);
        TableModelEvent evento;
    ...
    public BeanTabla10 getValue(int rowIndex) {
        try {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 1:
                return data.get(rowIndex).getCodigoXray();
            case 2:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        String aux;
        String valor;
        BeanTabla10 auxEmp = data.get(rowIndex);
        ...
        switch (columnIndex) {
            ...
            case 1:
                ...
                aux=String.valueOf(data.get(rowIndex).getCodigoXray());                
                data.get(rowIndex).setCodigoXray(valor);
                if(aux.equals(valor)){
        ...
        try {
            if (!eliminar) {
                ...
                while (iterar.hasNext()) {
                    BeanTabla10 bean = (BeanTabla10) iterar.next();
    ...
    public ArrayList<BeanTabla10> getData() {
        return data;
    }

    public void setData(ArrayList<BeanTabla10> data) {
        this.data = data;
    ...
    public HashSet<BeanTabla10> getListaCommit() {
        return listaCommit;
    }
}
