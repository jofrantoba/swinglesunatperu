...
/////////////********************* Mantemiento *////////////////////
        ...
        TreeEntry LibroBalanceGeneral = new TreeEntry("Correlativo ", picture.getIconPaquete(), "mcCorrelativo");
        ...
        ArrayList<TreeEntry> hijosContabilidadGeneral = new ArrayList();
            ...
            hijosContabilidadGeneral.add(itemContabilidadGeneralM);
                ...
                TreeEntry TipoCambio = new TreeEntry("Tipo de Cambio ", picture.getIconPaquete(), "mcCorrelativo");
                nietoContabilidadGeneral.add(TipoCambio);
                TreeEntry PeriodoContable = new TreeEntry("Períodos Contables ", picture.getIconPaquete(), "mcCorrelativo");
                nietoContabilidadGeneral.add(PeriodoContable);
                TreeEntry CuentaContable = new TreeEntry("Cuentas Contables ", picture.getIconPaquete(), "mcCorrelativo");
                nietoContabilidadGeneral.add(CuentaContable);
                TreeEntry Auxiliares = new TreeEntry("Auxiliares ", picture.getIconPaquete(), "mcCorrelativo");
                nietoContabilidadGeneral.add(Auxiliares);
                TreeEntry Asientostipo = new TreeEntry("Asientos tipo ", picture.getIconPaquete(), "mcCorrelativo");
                nietoContabilidadGeneral.add(Asientostipo);
                TreeEntry Autoridades = new TreeEntry("Autoridades ", picture.getIconPaquete(), "mcCorrelativo");
         ...
         // fin Proceso
            ...
            ArrayList<TreeEntry> nietoConsultaReporte = new ArrayList();
                ...
                TreeEntry AsientosR = new TreeEntry("Asientos ", picture.getIconPaquete(), "mcCorrelativo");
                nietoConsultaReporte.add(AsientosR);
